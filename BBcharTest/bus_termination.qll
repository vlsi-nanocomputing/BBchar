...
<qcalayout>
    ...
    <layout>
        ...
        <item comp="0" id="29" x="13" y="1" layer="0">
            <property name="phase" value="0"/>
        </item>
        <item comp="0" id="30" x="13" y="0" layer="0">
            <property name="phase" value="0"/>
        </item>
        <item comp="0" id="31" x="14" y="1" layer="0">
            <property name="phase" value="0"/>
        </item>
        <item comp="0" id="32" x="14" y="0" layer="0">
            <property name="phase" value="0"/>
        </item>
        <item comp="0" id="33" x="15" y="1" layer="0">
            <property name="phase" value="0"/>
        </item>
        <item comp="0" id="34" x="15" y="0" layer="0">
            <property name="phase" value="0"/>
        </item>
        <item comp="0" id="35" x="16" y="1" layer="0">
            <property name="phase" value="0"/>
        </item>
        <item comp="0" id="36" x="16" y="0" layer="0">
            <property name="phase" value="0"/>
        </item>
    </layout>
</qcalayout>
