...
outputPath = fullfile(BBcharPath,'Layouts','xor_2');
file = 'xor_2.qll';
...
driverPara.driverNames = [{'Dr_A'} {'Dr_B'} {'Dr_0'}]; %list of the drivers name as they are in the .qll file
...
driverPara.phasesRepetition = 9; % How many time NclockRegions repeat in the layout?
...
plotSettings.plotList = 241:clock_step:280;
...
charSettings.LibDeviceName = 'xor_2';
