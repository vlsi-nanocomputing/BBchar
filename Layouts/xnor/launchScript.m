...
outputPath = fullfile(BBcharPath,'Layouts','xnor');
file = 'xnor.qll';
...
driverPara.Ninputs = 4; %Number of physical input of the layout
driverPara.driverNames = [{'Dr1'} {'Dr2'} {'DrC0'} {'DrC1'}]; %list of the drivers name as they are in the .qll file
driverPara.driverModes = [{'0'} {'0'} {'1'} {'1'}; % Dr1 combinations
                          {'0'} {'1'} {'0'} {'1'}; % Dr2 combinations
                          {'0'} {'0'} {'0'} {'0'};
                          {'1'} {'1'} {'1'} {'1'}]; 
...
driverPara.phasesRepetition = 4; % How many time NclockRegions repeat in the layout?
...
charSettings.LibDeviceName = 'xnor';
