...
outputPath = fullfile(BBcharPath,'Layouts','xor');
file = 'xor.qll';
...
driverPara.phasesRepetition = 3; % How many time NclockRegions repeat in the layout?
...
charSettings.LibDeviceName = 'xor';
