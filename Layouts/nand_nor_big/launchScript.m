...
outputPath = fullfile(BBcharPath,'Layouts','nand_nor_big');
file = 'nand_nor_big.qll';
...
driverPara.driverNames = [{'DrA'} {'DrB'} {'DrC'}]; %list of the drivers name as they are in the .qll file
driverPara.driverModes = [{'0'} {'0'} {'0'} {'0'} {'1'} {'1'} {'1'} {'1'}; % a combinations
                          {'0'} {'0'} {'1'} {'1'} {'0'} {'0'} {'1'} {'1'}; % b combinations
                          {'0'} {'1'} {'0'} {'1'} {'0'} {'1'} {'0'} {'1'}]; %c combinations
...
driverPara.phasesRepetition = 2; % How many time NclockRegions repeat in the layout?
...
charSettings.LibDeviceName = 'nand_nor_big';
